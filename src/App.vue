<template>
        ...
        <nav class="max-w-7xl px-5 md:fixed top-0 z-[98] w-screen backdrop-blur-md bg-[#121212] bg-opacity-80">
            <div class="container mx-auto flex flex-wrap items-center justify-between">
                <button @click="redirectToHome" class="flex">
                    <span class="self-center text-lg text-[#ffdb70] font-semibold whitespace-nowrap fadein-bot hover:text-amber-100">Yiov</span>
                </button>
                <div class="flex md:order-2 fadein-bot">
                    <a href="https://github.com/Yiov" target="_blank"><img class="w-9 rounded-full" src="/zy-portofolio/github-logo.png" alt="github"></a>
                </div>
                <div class="hidden md:flex justify-between items-center w-full md:w-auto md:order-1" id="mobile-menu-3">
                    <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                        ...
                        <li>
                            <a href="https://yingyayi.com" target="_blank">
                                个人导航
                            </a>
                        </li>
                    </ul>
    ...
    <footer
        ...
        <nav class="flex justify-around py-4 text-xs">
            ...
            <router-link to="/about" class="text-gray-300 hover:text-white">技能</router-link>
