            ...
            items: [
                {
                    ...
                    status: '个人踩坑记录学习文档',
                    tech: 'VitePress',
                    github: 'https://github.com/Yiov/yiov.top',
                    demo: 'https://yiov.top'
                },
                {
                    id: 2,
                    ...
                    demo: 'https://vitepress.yiov.top'
                },
                {
                    id: 3,
                    name: 'VuePress搭建文档',
                    imageUrl: 'vuepress',
                    status: '全程图文教程，轻松搭建文档',
                    tech: 'VuePress',
                    github: 'https://github.com/Yiov/vuepress-doc',
                    demo: 'https://vuepress.yiov.top/'
                },
            ]
        };
    }
                                ...
                                <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
                                    ...
                                    <div class="w-full flex justify-end">
                                        <div class="flex cursor-pointer items-end gap-2 text-primary">
                                            <a v-if="item.github !== 'null'" :href="item.github" target="_blank"
                                                rel="noreferrer" title="查看源码" class="transition-all hover:text-accent">
                                            ...
                                            <a v-if="item.demo !== 'null'" :href="item.demo" target="_blank"
                                                rel="noreferrer" title="查看" class="transition-all hover:text-accent">
                                                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24"
